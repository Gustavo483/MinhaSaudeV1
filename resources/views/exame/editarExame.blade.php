    ...
    <div class="containerSistema">
        ...
        <form action="{{route('UpdateExame', ['id_exame'=> $exame])}}" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-6 mt-10">
                ...
                <input value="{{$exame->st_especialidade  ? : old('st_especialidade')}}" name="st_especialidade" type="text" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light" required>
            </div>
            ...
            <div class="mb-6">
                ...
                <input value="{{$exame->dt_data  ? : old('dt_data')}}" name="dt_data" type="date" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light" required>
            </div>
            <div class="errorValidation">
            ...
            <div class="mb-6">
                ...
                <input value="{{$exame->st_localizacao  ? : old('st_localizacao')}}" name="st_localizacao" type="text" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light" required>
            </div>
            <div class="errorValidation">
