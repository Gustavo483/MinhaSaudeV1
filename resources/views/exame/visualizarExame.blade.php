...
@section('content')
    ...
    <div class="containerSistema pb-10">
            ...
            <div class="relative p-4 w-full max-w-md max-h-full">
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="p-4 md:p-5 text-center">
                        ...
                        <a href="{{route('DeletarExame',['id_exame'=>$exame->id_exame])}}" data-modal-hide="popup-modal" type="button" class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center me-2">
                            Sim, tenho certeza.
                        </a>
        ...
        <div class="flex justify-center mb-10 pt-10">
            <p style="font-size: 25px; color: #5CC6BA; font-weight: bolder">Visualização de exame</p>
        </div>

        <div class="flex justify-end items-center">
            <!-- Editar Exame -->
            <a class="me-10" href="{{route('EditarExame',['id_exame' =>$exame->id_exame])}}">
                <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="#5CC6BA" class="bi bi-pencil" viewBox="0 0 16 16">
        ...
        <div class="mt-5">
            <span class="spanExame ">Especialidade :</span>
        ...
        <div class="mt-2">
            <span class="spanExame">Arquivos registrados:</span>
            @foreach($exame->arquivos as $arquivo)
                <div class="p-2 divArquivos">
                    ...
                    <div class="flex justify-center items-center mt-2">
                        <div class="me-5">
                            <a href="{{route('BaixarArquivo', ['id_arquivo'=> $arquivo->id_arquivo])}}">
                                <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="#5CC6BA" class="bi bi-arrow-down-circle" viewBox="0 0 16 16">
                                    <path fill-rule="evenodd" d="M1 8a7 7 0 1 0 14 0A7 7 0 0 0 1 8m15 0A8 8 0 1 1 0 8a8 8 0 0 1 16 0M8.5 4.5a.5.5 0 0 0-1 0v5.793L5.354 8.146a.5.5 0 1 0-.708.708l3 3a.5.5 0 0 0 .708 0l3-3a.5.5 0 0 0-.708-.708L8.5 10.293z"/>
                                </svg>
                            </a>
                        </div>
                        <button data-modal-target="excluirArquivo{{$arquivo->id_arquivo}}" data-modal-toggle="excluirArquivo{{$arquivo->id_arquivo}}" type="button">
        ...
        <div class="mt-5">
            @foreach($exame->notas as $nota)
                <div style="margin-top: 15px" class="borderNota">
                    <div class="flex justify-between">
                        <div>
                            <p style="color: #5CC6BA" class="text-center font-bold">{{$nota->st_nomeNota}}</p>
                        </div>
                        <div class="flex">
                            <div style="margin-right: 15px">
                                <button style="" onclick="EditarNota({{$nota->id_notaExame}},'{{$nota->st_nomeNota}}','{{$nota->st_descricao}}')" data-modal-target="editar-nota" data-modal-toggle="editar-nota" type="button">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#5CC6BA" class="bi bi-pencil" viewBox="0 0 16 16">
                                        <path d="M12.146.146a.5.5 0 0 1 .708 0l3 3a.5.5 0 0 1 0 .708l-10 10a.5.5 0 0 1-.168.11l-5 2a.5.5 0 0 1-.65-.65l2-5a.5.5 0 0 1 .11-.168l10-10zM11.207 2.5 13.5 4.793 14.793 3.5 12.5 1.207zm1.586 3L10.5 3.207 4 9.707V10h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.293zm-9.761 5.175-.106.106-1.528 3.821 3.821-1.528.106-.106A.5.5 0 0 1 5 12.5V12h-.5a.5.5 0 0 1-.5-.5V11h-.5a.5.5 0 0 1-.468-.325z"/>
                                    </svg>
                                </button>
                            </div>
                            <div>
                                <button data-modal-target="excluirNota{{$nota->id_notaExame}}" data-modal-toggle="excluirNota{{$nota->id_notaExame}}" type="button">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="red" class="bi bi-trash" viewBox="0 0 16 16">
                                        <path d="M5.5 5.5A.5.5 0 0 1 6 6v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5m2.5 0a.5.5 0 0 1 .5.5v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5m3 .5a.5.5 0 0 0-1 0v6a.5.5 0 0 0 1 0z"/>
                                        <path d="M14.5 3a1 1 0 0 1-1 1H13v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V4h-.5a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1H6a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1h3.5a1 1 0 0 1 1 1zM4.118 4 4 4.059V13a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1V4.059L11.882 4zM2.5 3h11V2h-11z"/>
                                    </svg>
