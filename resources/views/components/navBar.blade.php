<nav class="border-gray-200 bgNavBar ">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        <a href="{{route('HomeSistema')}}"  class="flex items-center space-x-3 rtl:space-x-reverse">
        ...
        <div class="hidden w-full md:block md:w-auto" id="navbar-default">
            <ul class="font-medium flex flex-col p-4 md:p-0 mt-4  rounded-lg md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 bgNavBar">
                ...
                <li>
                    <a href="/profile" class="block py-2 px-3 linkNavbar text-center">Perfil</a>
                </li>
                <li>
                    <a href="/sobre" class="block py-2 px-3 linkNavbar text-center">Sobre</a>
                </li>
                <li>
